...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        KSYBarView * lcBarVire = [[KSYBarView alloc]initWithFrame:M_RECT(0, 0, size.width, 30)];
        lcBarVire.backgroundColor = [UIColor greenColor];
        lcBarVire.tag = kBarViewtag+100;
        [self addSubview:lcBarVire];
        
        UIButton * btn = [[UIButton alloc]initWithFrame:M_RECT(0, 0, 50, 30)];
        btn.backgroundColor = [UIColor redColor];
        [lcBarVire addSubview:btn];
        ...
        UIImage *pauseImg = [UIImage imageNamed:@"bt_pause_hl@3x.png"];
//        [playBtn setBackgroundImage:pauseImg forState:UIControlStateNormal];
...
//        [barView addSubview:progressSlider];
        ...
        [episodeBtn setTitle:@"房间" forState:UIControlStateNormal];
        ...
        UIImage *forwardImg = [[ThemeManager sharedInstance] imageInCurThemeWithName:@"bt_forward_n ormal"];
