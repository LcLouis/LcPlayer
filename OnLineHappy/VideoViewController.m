...
@property (nonatomic, strong) AMZPlayer *player;
...
//    [demoView addSubview:nativeBtn];
    ...
    NSLog(@"%@",self.playStr);
    hlsField.text = self.playStr;
    //@"http://videodemo.kssws.ks-cdn.com/h265-h264/h264.1080.2m.mp4";//@"http://maichang.kssws.ks-cdn.com/upload20150716161913.mp4";//@"http://192.168.135.27/h265.1080p.20Min.1M.mp4";//@"http://115.231.96.121:8080/hls/test_ts/index.m3u8"; // **** 需WI-FI：123
...
//    errField.text = @"rtmp://live.test.ksyun.com/live/lhf";
...
- (void)initPlayer {
    _player = [[AMZPlayer alloc] initWithMURL:_videoUrl withOptions:nil allowLog:YES appIdentifier:@"ksy"];
...
////    _videoUrl = [NSURL URLWithString:@"http://longzhu.kssws.ks-cdn.com/447010_c032938f28a14b5282673914428a7930_1444639832.mp4"];
////    _videoUrl = [NSURL URLWithString:@"http://mp4.miu520.com/video/151012/1113858087891.mp4"];
////    _videoUrl = [NSURL URLWithString:@"http://longzhu.kssws.ks-cdn.com/284280_42aacf15e3864706ae40e1669bebdc10_1444895053.mp4"];
//    
//    
//    [self initPlayer];
//    
...
- (void)dealloc
{
    NSTimeInterval bggain = [[NSDate date]timeIntervalSince1970] * 1000;
